...
export function DialogForkFromTimeline(props: { sessionID: string; onMove: (messageID?: string) => void }) {
  ...
  const options = createMemo((): DialogSelectOption<string | undefined>[] => {
    ...
    const fullSession = {
      title: t("route.session.dialog.fork.full_session"),
      value: undefined,
  ...
  return <DialogSelect onMove={(option) => props.onMove(option.value)} title={t("route.session.dialog.fork.title")} options={options()} />
}
