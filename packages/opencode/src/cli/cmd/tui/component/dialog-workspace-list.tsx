...
export function DialogWorkspaceList() {
        ...
        return {
          title:
            removing() === workspace.id
              ? t("dialog.workspace_list.deleting")
              : deleting() === workspace.id
                ? t("dialog.workspace_list.confirm_delete", { name: workspace.name })
                : workspace.name,
          value: { workspace },
  ...
  async function remove(workspace: Workspace) {
    ...
    if (result?.error) {
      ...
      toast.show({
        variant: "error",
        title: t("dialog.workspace_list.delete_failed_title"),
  ...
  return (
    <DialogSelect
      title={t("dialog.workspace_list.title")}
      options={options()}
      onMove={(option) => {
        setDeleting(undefined)
      }}
